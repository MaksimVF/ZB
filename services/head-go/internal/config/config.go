...
type Config struct {
	...
	NetworkConfig  SimpleNetworkConfig   `json:"network_config"`
	AuthConfig     AuthConfig            `json:"auth_config"`
	FeaturesConfig *FeaturesConfig       `json:"features_config"`
	WebhookConfig  WebhookConfig         `json:"webhook_config"`
	ModelRegistry  *models.ModelRegistry `json:"model_registry"`
...
// NetworkConfig holds network-related configuration (simplified version for Config)
...
func Load() *Config {
	cfg := &Config{
		...
		ModelRegistry: models.DefaultModelRegistry(),
