...
func TestWebhookEndpoints(t *testing.T) {
	...
	t.Run("HeadStatusWebhook", func(t *testing.T) {
	...
	t.Run("RoutingDecisionWebhook", func(t *testing.T) {
		payload := map[string]interface{}{
...
func TestRateLimiter(t *testing.T) {
	...
	t.Run("RateLimiterAllow", func(t *testing.T) {
		ip := "192.168.1.1"
	...
	t.Run("RateLimiterMetrics", func(t *testing.T) {
		ip := "192.168.1.2"
...
func TestCircuitBreaker(t *testing.T) {
	...
	t.Run("CircuitBreakerAllow", func(t *testing.T) {
...
func TestMessageQueueIntegration(t *testing.T) {
	...
	t.Run("MessageQueueSubscribers", func(t *testing.T) {
		// Start subscribers
...
func TestExternalServiceIntegration(t *testing.T) {
	...
	t.Run("ExternalServiceClient", func(t *testing.T) {
