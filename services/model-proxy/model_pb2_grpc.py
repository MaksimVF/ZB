...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Generate = channel.unary_unary(
                ...
                request_serializer=model__pb2.GenRequest.SerializeToString,
                response_deserializer=model__pb2.GenResponse.FromString,
                _registered_method=True)
        self.GenerateStream = channel.unary_stream(
                '/model.ModelService/GenerateStream',
                request_serializer=model__pb2.GenRequest.SerializeToString,
                response_deserializer=model__pb2.GenResponse.FromString,
                _registered_method=True)
...
def add_ModelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Generate': grpc.unary_unary_rpc_method_handler(
                    servicer.Generate,
                    request_deserializer=model__pb2.GenRequest.FromString,
                    response_serializer=model__pb2.GenResponse.SerializeToString,
            ),
...
class ModelService(object):
    ...
    def Generate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/model.ModelService/Generate',
            model__pb2.GenRequest.SerializeToString,
            model__pb2.GenResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
